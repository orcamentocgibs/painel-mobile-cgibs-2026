(function(){
  ...
  if(sh){
    sh.addEventListener('click', function(){
      var data={title:'Painel do Orçamento CGIBS 2026', text:'Painel do Orçamento CGIBS 2026 — R$ 981,5 milhões. A primeira proposta orçamentária do CGIBS.', url:location.href};
